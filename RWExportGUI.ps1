...
Function BuildCommandLine ($Script,$Source,$Destination,$Sort,$Simple,$Smart,$CSSFile,$Prefix,$Suffix,$Details,$Indent,$Inline,$Keep,$Separate,$Split,$Log,$LogName) {
...
function GenerateForm {
   ...
   #Provide Custom Code for events specified in PrimalForms.
      ...
      $handler_ScriptButton_Click={
         ...
         $CommandLine = BuildCommandLine $ScriptText.Text $SourceText.Text $DestinationText.Text $SortMethod $SimpleImgText.Text $SmartImgText.Text $CSSText.Text $PrefixCheck.Checked $SuffixCheck.Checked $DetailsCheck.checked $IndentCheck.Checked $InlineStatsCheck.Checked $KeepStylesCheck.Checked $SeparateCheck.Checked $SplitTopicsCheck.Checked $LogCheck.Checked $LogText.Text
      ...
      $handler_CSSButton_Click={
         ...
         # $OpenFileDialog.showhelp = $true
         [void]$SaveFileDialog.ShowDialog()
         $CSSText.Text = $SaveFileDialog.filename.ToString()
         $SortMethod = $SortComboBox.SelectedIndex + 1
         $CommandLine = BuildCommandLine $ScriptText.Text $SourceText.Text $DestinationText.Text $SortMethod $SimpleImgText.Text $SmartImgText.Text $CSSText.Text $PrefixCheck.Checked $SuffixCheck.Checked $DetailsCheck.checked $IndentCheck.Checked $InlineStatsCheck.Checked $KeepStylesCheck.Checked $SeparateCheck.Checked $SplitTopicsCheck.Checked $LogCheck.Checked $LogText.Text
         $CommandText.Text = $CommandLine
      } # $handler_CSSButton_Click
      ...
      $handler_SplitTopicsCheck_CheckStateChanged={
         if ($SplitTopicsCheck.Checked) {
   ...
   $SplitTopicsCheck.Name = “IndentCheck”
   $Width = 15
   $Height = 15
   $SplitTopicsCheck.Size = New-Object System.Drawing.Size($Width,$Height)
   $SplitTopicsCheck.Add_CheckStateChanged($handler_SplitTopicsCheck_CheckStateChanged)
